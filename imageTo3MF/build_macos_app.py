...
APP_NAME = "LeadLight"
BUNDLE_ID = "com.ecohen.leadlight"
VERSION = "0.1.0"
PROJECT_DIR = Path(__file__).resolve().parent
ICON_SVG = PROJECT_DIR / "leadlight_icon.svg"
ENTRY_SCRIPT = PROJECT_DIR / "image_grade_to_3mf_gui.py"
...
/usr/bin/osascript -e 'display alert "LeadLight could not start" message "No project Python or uv executable was found." as critical'
exit 1
"""
